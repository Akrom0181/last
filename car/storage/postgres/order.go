...
// 	_, err := o.db.Exec(query, id.String(), order.CarId, order.CustomerId, order.FromDate, order.ToDate, order.Status, order.Payment_status, order.Amount)
// 	if err != nil {
// 		return "", err
// 	}
...
// 	_, err := o.db.Exec(query, order.Customer.Id, order.Car.Id, order.FromDate, order.ToDate, order.Status, order.Status, order.Payment_status, order.Id)
// 	if err != nil {
// 		return "", err
// 	}
